const BLOG = {
  ...
  socialLink: 'https://twitter.com/ZainCN',
  seo: {
  ...
  analytics: {
    provider: 'vercel', // Currently we support Google Analytics and Ackee, please fill with 'ga' or 'ackee', leave it empty to disable it.
    ackeeConfig: {
